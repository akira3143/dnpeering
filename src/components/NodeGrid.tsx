        ...
        <div className="glass-panel rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs font-mono border-collapse min-w-[760px]">
              <thead>
                <tr className="bg-black/60 border-b border-white/10 text-slate-400 text-[11px] uppercase tracking-wider font-sans select-none">
                  <th className="py-3.5 px-5 font-semibold text-left">节点名称 / 代号</th>
                  <th className="py-3.5 px-4 font-semibold text-left">状态</th>
                  <th className="py-3.5 px-4 font-semibold text-left">WireGuard Endpoint</th>
                  <th className="py-3.5 px-4 font-semibold text-center">推荐 MTU</th>
                  <th className="py-3.5 px-5 font-semibold text-right">操作</th>
                </tr>
              </thead>
                    ...
                    <tr key={node.id} className="hover:bg-white/[0.03] transition-colors group">
                      ...
                      <td className="py-4 px-5 align-middle">
                        <div className="flex items-center gap-3.5">
                          ...
                          <div>
                            <div className="font-sans font-semibold text-sm text-white group-hover:text-cyan-300 transition-colors">
                              {node.name}
                            </div>
