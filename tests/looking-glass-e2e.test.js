...
dn42_v6_mesh BGP        master6    up     2026-08-19 12:00:00  Established   Routes: 392 imported, 392 exported`);
        ...
        res.end(`BIRD 2.15.1 ready.
Table master4:
172.20.0.53/32 unicast [dn42_jp7_rr 2026-08-20 14:25:31] * (100) [AS4242423143i]
...
async function runTests() {
  ...
  assert(sanitizeTarget('fd5c:300e:8ae7::1/48') === 'fd5c:300e:8ae7::1/48', 'Sanitizer cleanly allowed valid IPv6 prefix');
  assert(sanitizeTarget('AS4242423143') === 'AS4242423143', 'Sanitizer cleanly allowed valid ASN string');
